          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemCount: userDir.students.length,
                itemBuilder: (context, i) {
                  final student = userDir.students[i];
                  final name = '${student.first_name} ${student.last_name}';
                  final idNumber = student.id_number ?? 'N/A';
                        ...
                        if (student.id != null) {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder:
                                  (context) =>
                                      ProfileScreen(userId: student.id!),
                            ),
                          );
                        }
                      },
