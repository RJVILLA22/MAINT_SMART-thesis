...
class ScrollableAdminTabComponent extends StatefulWidget {
  const ScrollableAdminTabComponent({Key? key}) : super(key: key);

  @override
  State<ScrollableAdminTabComponent> createState() =>
      _ScrollableAdminTabComponentState();
}

class _ScrollableAdminTabComponentState
    extends State<ScrollableAdminTabComponent> {
  int selectedIndex = 0; // Default tab
  final List<String> tabs = ['BORROWED', 'AVAILABLE', 'ALL TOOLS'];
  ...
  void initState() {
    super.initState();
    screens = [BorrowedToolsScreen(), AvailableToolsScreen(), AllToolsScreen()];
  }
